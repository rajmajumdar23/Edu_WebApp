...
const ProductList5 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 83 && Product.id <= 102;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/CS.jpg" alt="" style={{width:"95rem",marginLeft:"-10rem",marginTop:"-9rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Cyber Security's power! Enroll now for a top-notch Cyber Security course, code your dreams."
      </div>
      <div className="row">
