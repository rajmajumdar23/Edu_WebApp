...
const ProductList10 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 183 && Product.id <= 198;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/Next.jpg" alt="" style={{width:"95rem",marginLeft:"-10rem",marginTop:"-8rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Next Js's power! Enroll now for a top-notch Next Js course, code your dreams."
      </div>
      <div className="row">
