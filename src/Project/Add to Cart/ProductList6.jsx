...
const ProductList6 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 103 && Product.id <= 122;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/CN.jpg" alt="" style={{width:"79rem",marginLeft:"-1rem",marginTop:"-8rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Computer Networks's power! Enroll now for a top-notch Computer Networks course, code your dreams."
      </div>
      <div className="row">
