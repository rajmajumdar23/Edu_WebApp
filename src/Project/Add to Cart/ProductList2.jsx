...
const ProductList2 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 21 && Product.id <= 41;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/WD.jpg" alt="" style={{width:"79rem",marginLeft:"-1rem",marginTop:"-8rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Web Development's power! Enroll now for a top-notch Web Development course, code your dreams."
      </div>
      <div className="row">
