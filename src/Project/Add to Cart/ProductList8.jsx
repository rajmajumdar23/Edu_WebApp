...
const ProductList8 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 143 && Product.id <= 162;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/React.jpg" alt="" style={{width:"95rem",marginLeft:"-10rem",marginTop:"-8rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master React's power! Enroll now for a top-notch React course, code your dreams."
      </div>
      <div className="row">
