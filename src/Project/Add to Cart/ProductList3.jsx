...
const ProductList3 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 42 && Product.id <= 62;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/DS.jpg" alt="" style={{width:"95rem",marginLeft:"-10rem",marginTop:"-8rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Data Science's power! Enroll now for a top-notch Data Science course, code your dreams."
      </div>
      <div className="row">
