...
const ProductList4 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 63 && Product.id <= 82;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/Java.jpg" alt="" style={{width:"79rem",marginLeft:"-1rem",marginTop:"-7rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Java's power! Enroll now for a top-notch Java course, code your dreams."
      </div>
      <div className="row">
