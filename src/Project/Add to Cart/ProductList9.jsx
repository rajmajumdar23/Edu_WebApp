...
const ProductList9 = () => {
  ...
  const filterDataRange = (Product) => {
    return Product.id >= 163 && Product.id <= 182;
  };
  ...
  return (
    <div style={{ marginTop: "10rem" }}>
      <img src="/Course-img/Vue.png" alt="" style={{width:"79rem",marginLeft:"-1rem",marginTop:"-7.5rem"}}/>
      <div className="label" style={{ width: "95rem", padding: "1rem", background: "black", color: "white", fontSize: "1.5rem", fontWeight: "600", marginLeft: "-10rem", marginBottom: "2rem" }}>
        "Master Vue's power! Enroll now for a top-notch Vue course, code your dreams."
      </div>
      <div className="row">
